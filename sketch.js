...
function preload(){
boyImage = loadImage( "alienBeige.png");
boyWalk = loadImage("alienBeige_walk.png");
boyJump = loadImage("alienBeige_jump.png");
boyDuck = loadImage("alienBeige_duck.png");
backDropImg = loadImage("background.png");
obstacleImage = loadImage("chainsaw.png")
